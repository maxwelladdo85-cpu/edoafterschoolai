import { ac as useRouter, Y as reactExports, L as isRedirect, P as jsxRuntimeExports, l as createServerFn, f as commonjsGlobal, z as getDefaultExportFromCjs, R as React } from "./server-Cxw6WwHr.js";
import { u as useAuth, L as Link, t as toast, f as createSsrRpc, h as useNavigate } from "./router-BcETnmHN.js";
import { s as supabase } from "./client-Ba9waXZY.js";
import { V as Video, B as Bell, c as ClipboardCheck, W as WandSparkles, S as SidebarProvider, a as AppSidebar, d as SidebarTrigger, N as NotificationBell } from "./NotificationBell-BKNCo5D8.js";
...
import { B as Button, c as clsx } from "./button-DInpa_86.js";
import { P as PageHero } from "./PageHero-CQ-1rbtd.js";
import { i as dashboardHero, A as AlertDialog, c as AlertDialogContent, f as AlertDialogHeader, g as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, b as AlertDialogCancel, a as AlertDialogAction } from "./dashboard-hero-DCxEPOj5.js";
import { S as STYLE_LABELS, a as STYLE_TIPS } from "./vark-Q3Rb9CFW.js";
...
import { L as Label$1 } from "./label-DZyQQ6B1.js";
...
import { C as CalendarRange, D as Download, T as Table, d as TableHeader, e as TableRow, c as TableHead, a as TableBody, b as TableCell, f as format$1, S as Search } from "./table-DXDKGnwf.js";
import { F as FileText } from "./file-text-DKVFgU-w.js";
import { r as requireSupabaseAuth } from "./auth-middleware-BU6DgO9n.js";
import { o as objectType, s as stringType, a as arrayType, l as literalType, e as enumType } from "./types-Ch40mmLW.js";
import { U as Upload } from "./upload-vQgmjuK5.js";
import { C as CircleCheck } from "./circle-check-CLUGLzcT.js";
import { t as toDate, c as constructFrom, b as millisecondsInHour, d as millisecondsInMinute } from "./en-US-croqg5Ht.js";
import { C as Check } from "./index-x37Yg8v9.js";
...
function VirtualClassesPanel({ mode, limit = 4 }) {
  const { user } = useAuth();
  const [rows, setRows] = reactExports.useState([]);
  const [loading, setLoading] = reactExports.useState(true);
  const [, force] = reactExports.useState(0);
  reactExports.useEffect(() => {
    const t = setInterval(() => force((n) => n + 1), 3e4);
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      ...
      const pastCutoff = new Date(Date.now() - 30 * 24 * 60 * 60 * 1e3).toISOString();
      const [{ data: upcomingData, error: upErr }, { data: pastData, error: pastErr }] = await Promise.all([
        supabase.from("virtual_classes").select("*").gte("scheduled_at", nowIso).order("scheduled_at", { ascending: true }).limit(limit),
        supabase.from("virtual_classes").select("*").lt("scheduled_at", nowIso).gte("scheduled_at", pastCutoff).order("scheduled_at", { ascending: false }).limit(limit)
      ]);
      if (cancelled) return;
      if (upErr || pastErr) {
        ...
        if (courseIds.length) {
          ...
          const map2 = new Map((cs ?? []).map((c2) => [c2.id, c2.title]));
          setRows(list.map((r) => ({ ...r, course: { title: map2.get(r.course_id) ?? "" } })));
        } else {
          setRows(list);
        }
      }
  ...
  const handleJoin = async (c2) => {
    if (mode === "learner" && user) {
      await supabase.from("virtual_class_attendance").insert({ class_id: c2.id, learner_id: user.id });
    }
    window.open(c2.zoom_url, "_blank", "noopener,noreferrer");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
      ...
      mode === "teacher" && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "sm", variant: "outline", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/virtual-classes", children: "Manage" }) })
    ] }),
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "py-6 text-center text-muted-foreground", children: "Loading…" }) }) : rows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-dashed", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "flex flex-col items-center gap-2 py-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-8 w-8 text-muted-foreground" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: mode === "teacher" ? "No virtual classes scheduled yet." : "No upcoming classes from your enrolled courses." }),
      mode === "teacher" && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "sm", className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/virtual-classes", children: "Schedule a class" }) })
    ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 md:grid-cols-2", children: rows.map((c2) => {
      const status = getStatus(c2);
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base truncate", children: c2.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardDescription, { className: "truncate", children: [
              c2.course?.title ?? "Course",
              " · ",
              c2.duration_minutes,
              " min"
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground flex items-center gap-1.5", children: [
            ...
            " ",
            formatWhen(c2.scheduled_at)
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
            status !== "ended" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                size: "sm",
                onClick: () => handleJoin(c2),
                disabled: status === "upcoming",
                title: status === "upcoming" ? "Join opens 10 minutes before start" : void 0,
                children: [
            ...
            c2.recording_url && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: c2.recording_url, target: "_blank", rel: "noopener noreferrer", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlay, { className: "mr-1 h-3.5 w-3.5" }),
              " Watch recording"
            ] }) }),
            status === "ended" && !c2.recording_url && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: "Recording not yet posted" })
          ] })
        ] })
      ] }, c2.id);
    }) })
...
function StatusBadge({ status }) {
  if (status === "live") return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-destructive text-destructive-foreground animate-pulse", children: "LIVE" });
  if (status === "upcoming") return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: "Upcoming" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "Ended" });
}
const CATEGORIES = [
...
function ReportTeacherCard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-destructive/30", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Confidentially flag a concern about a teacher. Reports go straight to admins." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onOpenChange: setOpen, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "destructive", size: "sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { className: "h-4 w-4 mr-1" }),
          "File a report"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Report a teacher" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Your identity is shared only with administrators reviewing the report." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Teacher" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: teacherKey, onValueChange: setTeacherKey, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: teachers.length ? "Pick a teacher" : "No course teachers found" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: teachers.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: `${t.teacher_id}|${t.course_id}`, children: [
                  t.full_name ?? t.email ?? "Teacher",
                  " — ",
                  t.course_title
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: category, onValueChange: setCategory, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "What is the concern about?" }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "What happened?" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setOpen(false), disabled: submitting, children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "destructive", onClick: submit, disabled: submitting, children: submitting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    mine.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground mb-2", children: "Your recent reports" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y rounded-md border", children: mine.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center justify-between gap-3 p-3 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium truncate", children: r.category }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: new Date(r.created_at).toLocaleString() })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: r.status === "resolved" ? "default" : r.status === "dismissed" ? "secondary" : "outline", children: r.status })
      ] }, r.id)) })
    ] })
  ] });
}
function LearnerDashboard() {
  ...
  const [vark, setVark] = reactExports.useState(null);
  reactExports.useEffect(() => {
    if (!user) return;
    let cancelled = false;
    (async () => {
      const [eRes, nRes, vRes] = await Promise.all([
        supabase.from("enrollments").select("id, progress, course:courses(title, subject, description)").eq("learner_id", user.id),
        supabase.from("notifications").select("*").eq("user_id", user.id).order("created_at", { ascending: false }).limit(5),
        supabase.from("vark_results").select("id, dominant, created_at").eq("learner_id", user.id).order("created_at", { ascending: false }).limit(1).maybeSingle()
      ]);
      if (cancelled) return;
      setEnrollments(eRes.data ?? []);
      setNotifications(nRes.data ?? []);
      setVark(vRes.data ?? null);
    })();
    return () => {
      cancelled = true;
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid gap-4 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, {}), label: "Enrolled Courses", value: enrollments.length, tint: "from-primary/15 to-primary/5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, {}), label: "Avg Progress", value: `${Math.round(enrollments.reduce((s2, e) => s2 + e.progress, 0) / Math.max(1, enrollments.length))}%`, tint: "from-emerald-500/15 to-emerald-500/5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, {}), label: "Unread Alerts", value: notifications.filter((n) => !n.is_read).length, tint: "from-gold/20 to-gold/5" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { children: vark ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 bg-gradient-to-br from-primary/15 to-gold/10", style: { boxShadow: "var(--shadow-card)" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-2xl", children: [
          "You learn best as a ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: STYLE_LABELS[vark.dominant] }),
          " learner"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardDescription, { children: [
          "Based on your VARK quiz on ",
          new Date(vark.created_at).toLocaleDateString(),
          "."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "list-disc space-y-1 pl-5 text-sm", children: STYLE_TIPS[vark.dominant].slice(0, 3).map((tip, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: tip }, i)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", size: "sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/vark-quiz", children: "Retake quiz" }) })
      ] })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 bg-gradient-to-br from-primary/15 to-gold/10", style: { boxShadow: "var(--shadow-card)" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "w-fit gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-3 w-3" }),
          " New"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Discover how you learn best" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Take our quick 8-question VARK quiz to find your learning style and get tips made for you." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/vark-quiz", children: "Take the VARK quiz" }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(VirtualClassesPanel, { mode: "learner" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ReportTeacherCard, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-3 text-xl font-semibold", children: "Courses" }),
      enrollments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "py-8 text-center text-muted-foreground", children: "You aren't enrolled in any courses yet." }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 md:grid-cols-2", children: enrollments.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: e.course?.title ?? "Course" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: e.course?.subject })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: e.progress }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground line-clamp-2", children: e.course?.description })
        ] })
      ] }, e.id)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-3 text-xl font-semibold", children: "Notifications" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: notifications.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "p-6 text-center text-muted-foreground", children: "No notifications." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y", children: notifications.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mt-1 h-2 w-2 shrink-0 rounded-full ${n.is_read ? "bg-muted" : "bg-primary"}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: n.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: n.message })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: new Date(n.created_at).toLocaleDateString() })
      ] }, n.id)) }) }) })
    ] })
  ] });
}
function StatCard({ icon, label, value, tint = "from-primary/15 to-primary/5" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: `border-0 bg-gradient-to-br ${tint}`, style: { boxShadow: "var(--shadow-card)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "flex items-center gap-4 p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 text-primary", children: icon }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
async function callTeacherAi(payload) {
...
function QuizGenerator() {
  ...
  const [questions, setQuestions] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Lesson text" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Textarea,
        {
          value: text,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: generate, disabled: loading, children: [
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ListChecks, { className: "mr-2 h-4 w-4" }),
      "Generate 10 MCQs"
    ] }),
    questions && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
          questions.length,
          " questions generated"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CopyButton, { text: JSON.stringify(questions, null, 2) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: questions.map((q, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-2 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-medium", children: [
          i + 1,
          ". ",
          q.question
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1 text-sm", children: q.options.map((o, j) => {
          const letter = String.fromCharCode(65 + j);
          const correct = q.answer?.toString().toUpperCase().startsWith(letter);
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: correct ? "font-semibold text-primary" : "", children: [
            letter,
            ". ",
            o,
            correct ? "  ✓" : ""
        ...
        q.explanation && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Why:" }),
          " ",
          q.explanation
        ] })
      ] }) }, i)) })
...
function MarkdownResult({ content }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CopyButton, { text: content }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border bg-muted/30 p-4 text-sm whitespace-pre-wrap leading-relaxed", children: content })
  ] });
}
function LessonPlanner() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 sm:grid-cols-[1fr_140px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Topic" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: topic, onChange: (e) => setTopic(e.target.value), placeholder: "e.g. Photosynthesis for JSS2" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Duration (min)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", min: 10, max: 240, value: duration, onChange: (e) => setDuration(e.target.value) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: generate, disabled: loading, children: [
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarRange, { className: "mr-2 h-4 w-4" }),
      "Generate Lesson Plan"
    ] }),
    content && /* @__PURE__ */ jsxRuntimeExports.jsx(MarkdownResult, { content })
  ] });
}
function ContentSummariser() {
  ...
  const generate = async () => {
    if (text.trim().length < 100) {
      toast.error("Paste a longer document.");
      return;
    }
    setLoading(true);
    setContent(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Document" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { rows: 8, value: text, onChange: (e) => setText(e.target.value), placeholder: "Paste the document text…" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: generate, disabled: loading, children: [
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "mr-2 h-4 w-4" }),
...
function GradingAssist() {
  ...
  const [content, setContent] = reactExports.useState(null);
  const generate = async () => {
    if (!criteria.trim() || !answer.trim()) {
      toast.error("Provide both criteria and the student's answer.");
      return;
    }
    setLoading(true);
    setContent(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Marking criteria" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { rows: 6, value: criteria, onChange: (e) => setCriteria(e.target.value), placeholder: "e.g. Out of 10. Award marks for clear thesis, evidence, structure, grammar…" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Student answer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { rows: 6, value: answer, onChange: (e) => setAnswer(e.target.value), placeholder: "Paste the student's essay answer…" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: generate, disabled: loading, children: [
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "mr-2 h-4 w-4" }),
      "Suggest mark & feedback"
    ] }),
    content && /* @__PURE__ */ jsxRuntimeExports.jsx(MarkdownResult, { content })
  ] });
}
function AiTeachingAssistantPanel() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border/60", style: { boxShadow: "var(--shadow-card)" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-8 w-8 items-center justify-center rounded-full bg-primary/10 text-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4" }) }),
        "AI Teaching Assistant"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Four AI-powered helpers to speed up planning, assessment and grading." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "quiz", className: "w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid w-full grid-cols-2 md:grid-cols-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "quiz", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ListChecks, { className: "mr-2 h-4 w-4" }),
          "Quiz"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "plan", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarRange, { className: "mr-2 h-4 w-4" }),
          "Lesson Plan"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "summary", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "mr-2 h-4 w-4" }),
          "Summariser"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "grading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "mr-2 h-4 w-4" }),
          "Grading"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "quiz", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(QuizGenerator, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "plan", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LessonPlanner, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "summary", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContentSummariser, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "grading", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GradingAssist, {}) })
    ] }) })
  ] });
}
function TeacherSummary() {
  ...
  const [enrollments, setEnrollments] = reactExports.useState(0);
  const [lessons, setLessons] = reactExports.useState(0);
  const [assessments, setAssessments] = reactExports.useState(0);
  const [loading, setLoading] = reactExports.useState(true);
  reactExports.useEffect(() => {
    const load = async () => {
      if (!user) return;
      setLoading(true);
      const { data: cs } = await supabase.from("courses").select("id,title,subject,class_level,is_active,created_at,thumbnail_url").eq("teacher_id", user.id).order("created_at", { ascending: false });
      const list = cs ?? [];
      setCourses(list);
      const ids = list.map((c2) => c2.id);
      if (ids.length) {
  ...
  const active = courses.filter((c2) => c2.is_active).length;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-wrap items-end justify-between gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-base md:text-lg text-white/85", children: "A snapshot of everything you've created — courses, lessons and learners — in one elegant view." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "secondary", className: "bg-white/10 text-white hover:bg-white/20 border-white/20 border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/my-courses", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "mr-2 h-4 w-4" }),
                "Manage"
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, className: "bg-gold text-gold-foreground hover:opacity-90", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/courses/builder", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5", children: stats.map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        className: `relative overflow-hidden border-0 bg-gradient-to-br ${s2.tint}`,
        style: { boxShadow: "var(--shadow-card)" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium text-muted-foreground", children: s2.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex h-9 w-9 items-center justify-center rounded-full ${s2.iconClass}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(s2.icon, { className: "h-4 w-4" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl font-bold tracking-tight", children: loading ? "—" : s2.value }) })
        ]
      },
      s2.label
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(VirtualClassesPanel, { mode: "teacher" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AiTeachingAssistantPanel, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight", children: "Recent courses" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
            lessons,
            " lesson",
            lessons === 1 ? "" : "s",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "ghost", className: "gap-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/my-courses", children: [
          "View all ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4" })
        ] }) })
      ] }),
      courses.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-dashed", style: { background: "var(--gradient-emerald-soft)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "flex flex-col items-center gap-3 py-16 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-medium", children: "No courses yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-sm text-sm text-muted-foreground", children: "Create your first course and start sharing knowledge with learners across Edo State." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/courses/builder", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(WandSparkles, { className: "mr-2 h-4 w-4" }),
          "Open Course Builder"
        ] }) })
      ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", children: courses.slice(0, 5).map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          className: "group overflow-hidden border-border/60 transition-all hover:-translate-y-0.5",
          style: { boxShadow: "var(--shadow-card)" },
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "flex items-center gap-4 p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "relative h-16 w-28 flex-none overflow-hidden rounded-lg bg-muted bg-cover bg-center ring-1 ring-border",
                style: c2.thumbnail_url ? { backgroundImage: `url(${c2.thumbnail_url})` } : { backgroundImage: "var(--gradient-hero)" },
                children: !c2.thumbnail_url && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center text-white/80", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-6 w-6" }) })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "truncate font-semibold", children: c2.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    variant: c2.is_active ? "default" : "secondary",
                    className: c2.is_active ? "" : "bg-gold/20 text-gold-foreground hover:bg-gold/30",
                    children: c2.is_active ? "Active" : "Draft"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-sm text-muted-foreground", children: [c2.subject, c2.class_level].filter(Boolean).join(" · ") || "No subject yet" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden text-right text-xs text-muted-foreground sm:block", children: new Date(c2.created_at).toLocaleDateString(void 0, { month: "short", day: "numeric", year: "numeric" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/courses/builder", search: { id: c2.id }, children: [
...
}).parse(input)).handler(createSsrRpc("9bbb7c14a0ddc72c5256a0aebc364ab3c0d1d93312f6246455149d3b8d58cdc2"));
...
const bulkCreateUsers = createServerFn({
  method: "POST"
}).middleware([requireSupabaseAuth]).inputValidator((input) => InputSchema.parse(input)).handler(createSsrRpc("576d0135ae258276f3ecc55e61cc0e30cae4f06f1270eb8d895f0247e84f0a20"));
...
function parseCSV(text) {
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    const row = {
      ...
      class_level: iClass >= 0 ? cells[iClass] : void 0,
      lga: iLga >= 0 ? cells[iLga] : void 0,
      password: iPwd >= 0 ? cells[iPwd] : void 0
    };
...
function BulkUploadUsers({ onDone }) {
  ...
  const handleFile = async (file) => {
    ...
    if (parsed.length > 500) {
      toast.error("Maximum 500 rows per upload");
      return;
    }
    setRows(parsed);
  ...
  const downloadResults = () => {
    ...
    downloadCsv(`bulk-upload-results-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.csv`, csv);
  };
  const reset = () => {
    setRows([]);
    setResults(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
      ...
      " Bulk upload learners & teachers"
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
        "Upload a CSV to onboard multiple users at once. Required columns:",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: "email, full_name, role" }),
        ". Optional:",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: "class_level, lga, password" }),
        ". Role must be",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: "learner" }),
        " or ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: "teacher" }),
        ". If password is blank a secure one is generated for you and returned in the results CSV."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => downloadCsv("bulk-users-template.csv", TEMPLATE_CSV), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4 mr-2" }),
          " Download template"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => fileRef.current?.click(), disabled: busy, children: [
        ...
        rows.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", onClick: submit, disabled: busy || validCount === 0, children: busy ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", onClick: reset, disabled: busy, children: "Clear" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
      ...
      rows.length > 0 && !results && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 text-sm", children: [
          ...
          errorCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "destructive", children: [
            errorCount,
            " invalid"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border max-h-72 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "LGA" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: rows.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-xs", children: r.email }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: r.full_name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: r.role === "teacher" ? "default" : "secondary", children: r.role }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: r.class_level ?? "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: r.lga ?? "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: r._error ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive text-xs", children: r._error }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 text-emerald-500" }) })
          ] }, i)) })
        ] }) })
      ] }),
      results && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 text-sm", children: [
            ...
            results.some((r) => !r.ok) && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "destructive", children: [
              results.filter((r) => !r.ok).length,
              " failed"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", onClick: downloadResults, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4 mr-2" }),
            " Download results (incl. passwords)"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border max-h-72 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Temp password / Error" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: results.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-muted-foreground", children: r.row }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-xs", children: r.email }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: r.role }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: r.ok ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-emerald-600 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-3 w-3" }),
              "Created"
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-destructive text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3 w-3" }),
              "Failed"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-xs", children: r.ok ? r.password : r.error })
          ] }, r.row)) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Passwords are shown once. Download the results CSV and share credentials securely — users should change their password after first sign-in." })
      ] })
    ] })
  ] });
}
...
function TeacherReportsPanel() {
  ...
  const load = async () => {
    const { data, error } = await supabase.rpc("admin_list_teacher_reports", {
      p_status: filter === "all" ? void 0 : filter
    });
    if (error) return toast.error(error.message);
    setReports(data ?? []);
  };
  ...
  const save = async () => {
    ...
    const { error } = await supabase.rpc("admin_update_teacher_report", {
      p_report_id: editing.id,
      p_status: status,
      p_admin_notes: notes || void 0
    });
    if (error) return toast.error(error.message);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { className: "h-4 w-4 text-destructive" }),
        " Teacher reports",
        openCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "destructive", children: [
          openCount,
          " open"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: filter, onValueChange: setFilter, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          ...
          STATUSES.map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s2, children: s2 }, s2))
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: reports.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground py-6 text-center", children: "No reports." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y rounded-md border", children: reports.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "p-4 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-medium", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground font-normal", children: [
              "· ",
              r.teacher_name ?? r.teacher_email ?? "Teacher"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
            "Reported by ",
            r.reporter_name ?? r.reporter_email ?? "Learner",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: r.status === "open" ? "destructive" : r.status === "resolved" ? "default" : "secondary", children: r.status }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", onClick: () => openCard(r), children: "Review" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground line-clamp-2", children: r.details })
    ] }, r.id)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!editing, onOpenChange: (o) => !o && setEditing(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: editing?.category }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogDescription, { children: [
          "Teacher: ",
          editing?.teacher_name ?? editing?.teacher_email,
          " · Reporter: ",
          editing?.reporter_name ?? editing?.reporter_email,
          editing?.course_title ? ` · ${editing.course_title}` : ""
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border bg-muted/40 p-3 text-sm whitespace-pre-wrap", children: editing?.details }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: status, onValueChange: setStatus, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: STATUSES.map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s2, children: s2 }, s2)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Admin notes" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { value: notes, onChange: (e) => setNotes(e.target.value), placeholder: "Actions taken, findings, follow-ups…", rows: 4 })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
...
function AdminDashboard() {
  ...
  const [weekly, setWeekly] = reactExports.useState([]);
  const [top, setTop] = reactExports.useState([]);
  const [completion, setCompletion] = reactExports.useState([]);
  ...
  const loadAll = async () => {
    ...
    if (wk.data) setWeekly(wk.data.map((r) => ({ day: r.day, enrollments: Number(r.enrollments) })));
    if (tc.data) setTop(tc.data.map((r) => ({ ...r, enrollments: Number(r.enrollments) })));
    if (cr.data) setCompletion(cr.data.map((r) => ({ ...r, completion_pct: Number(r.completion_pct) })));
    if (da.data) setDau(da.data.map((r) => ({ day: r.day, active_users: Number(r.active_users) })));
    if (pt.data) setPending(pt.data);
    const rolesByUser = {};
    (roles.data ?? []).forEach((r) => {
      rolesByUser[r.user_id] = [...rolesByUser[r.user_id] ?? [], r.role];
    });
    setUsers((profiles.data ?? []).map((p) => ({ ...p, roles: rolesByUser[p.id] ?? [] })));
  };
  reactExports.useEffect(() => {
    loadAll();
  }, []);
  ...
  const downloadCsv2 = (filename, rows) => {
    if (!rows.length) return toast.error("No data to export");
    const headers = Object.keys(rows[0]);
    const escape = (v) => {
      if (v === null || v === void 0) return "";
      const s2 = typeof v === "string" ? v : v instanceof Date ? v.toISOString() : String(v);
      return /[",\n]/.test(s2) ? `"${s2.replace(/"/g, '""')}"` : s2;
    };
  ...
  const exportUsers = () => {
    ...
    downloadCsv2(`users-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.csv`, rows);
    toast.success(`Exported ${rows.length} users`);
  };
  const exportActivity = async () => {
    const { data, error } = await supabase.rpc("admin_user_activity_log", { p_limit: 1e4 });
    if (error) return toast.error(error.message);
    downloadCsv2(`activity-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.csv`, data ?? []);
  ...
  const exportLogins = async () => {
    ...
    if (error) return toast.error(error.message);
    downloadCsv2(`active-users-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.csv`, data ?? []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, {}), label: "Total Learners", value: overview?.total_learners ?? "—", tint: "from-primary/15 to-primary/5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, {}), label: "Total Teachers", value: overview?.total_teachers ?? "—", tint: "from-gold/20 to-gold/5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, {}), label: "Active Courses", value: overview?.total_courses ?? "—", tint: "from-emerald-500/15 to-emerald-500/5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Video, {}), label: "Sessions Today", value: overview?.active_sessions_today ?? "—", tint: "from-sky-500/15 to-sky-500/5" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4" }),
        " Export reports"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "flex flex-wrap gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: exportUsers, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4 mr-2" }),
          " Users (CSV)"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: exportActivity, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4 mr-2" }),
          " User activity (CSV)"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: exportLogins, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4 mr-2" }),
          " Active users / last seen (CSV)"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "w-full text-xs text-muted-foreground mt-1", children: "CSV files open directly in Excel and Google Sheets." })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid gap-4 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Weekly enrollments" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "h-[280px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: weekly, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "var(--border)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "day", tickFormatter: (d) => format$1(parseISO(d), "EEE"), stroke: "var(--muted-foreground)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { allowDecimals: false, stroke: "var(--muted-foreground)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: { background: "var(--card)", border: "1px solid var(--border)" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "enrollments", fill: "var(--primary)", radius: [6, 6, 0, 0] })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Top 5 courses by enrollments" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "h-[280px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: top, layout: "vertical", margin: { left: 20 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "var(--border)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { type: "number", allowDecimals: false, stroke: "var(--muted-foreground)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { dataKey: "title", type: "category", width: 140, stroke: "var(--muted-foreground)", tick: { fontSize: 12 } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: { background: "var(--card)", border: "1px solid var(--border)" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "enrollments", fill: "var(--gold)", radius: [0, 6, 6, 0] })
        ] }) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid gap-4 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Daily active users (last 14d)" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "h-[280px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: dau, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "var(--border)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "day", tickFormatter: (d) => format$1(parseISO(d), "MMM d"), stroke: "var(--muted-foreground)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { allowDecimals: false, stroke: "var(--muted-foreground)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: { background: "var(--card)", border: "1px solid var(--border)" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Legend, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "active_users", stroke: "var(--primary)", strokeWidth: 2, dot: false })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Course completion rates" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-3 max-h-[280px] overflow-auto", children: completion.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No data yet." }) : completion.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate pr-2", children: c2.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium tabular-nums", children: [
              c2.completion_pct,
              "%"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: c2.completion_pct })
        ] }, c2.course_id)) })
      ] })
    ] }),
    pending.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mb-3 text-xl font-semibold flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(UserCog, { className: "h-5 w-5" }),
        " Pending teacher approvals",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", children: pending.length })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: pending.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: new Date(p.created_at).toLocaleDateString() }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-right space-x-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", onClick: () => approveTeacher(p.id), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4 mr-1" }),
              " Approve"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", onClick: () => rejectTeacher(p.id), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-3 text-xl font-semibold", children: "Bulk onboarding" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(BulkUploadUsers, { onDone: loadAll })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-3 text-xl font-semibold", children: "Whistle-blow · Teacher reports" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TeacherReportsPanel, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between gap-3 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "User management" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: filteredUsers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: 6, className: "py-8 text-center text-muted-foreground", children: "No users found." }) }) : filteredUsers.map((u) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: u.roles.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: r === "admin" ? "destructive" : r === "teacher" ? "default" : "secondary", children: r }, r)) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: u.status === "active" ? "default" : u.status === "pending" ? "outline" : "secondary", children: u.status }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2", children: [
            u.status !== "pending" && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", onClick: () => toggleStatus(u.id, u.status), children: u.status === "active" ? "Deactivate" : "Activate" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "destructive", onClick: () => openDelete(u), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!deleteTarget, onOpenChange: (o) => !o && setDeleteTarget(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Permanently delete user?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
          "This will permanently delete ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: deleteTarget?.full_name ?? deleteTarget?.email }),
          " ",
          "and all associated records (enrollments, completions, messages, certificates, etc.). This action cannot be undone and will be recorded in the admin audit log."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Label$1, { htmlFor: "confirm-email", children: [
            "Type the user's email ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: deleteTarget?.email }),
            " to confirm"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "reason", children: "Reason (optional, logged for audit)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
              id: "reason",
...
function Stat({ icon, label, value, tint = "from-primary/15 to-primary/5" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: `border-0 bg-gradient-to-br ${tint}`, style: { boxShadow: "var(--shadow-card)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "flex items-center gap-4 p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 text-primary", children: icon }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: label }),
...
function DashboardPage() {
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      const {
        data: sent
      } = await supabase.rpc("send_birthday_greeting_if_due");
      if (sent === true) toast.success("🎂 Happy Birthday from Edo SUBEB!");
      const {
        data: p
      } = await supabase.from("profiles").select("date_of_birth").eq("id", user.id).maybeSingle();
      if (p && p.date_of_birth == null) {
        toast.message("Add your date of birth in Settings so we can wish you a happy birthday!", {
          duration: 6e3
        });
      }
    })();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen w-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex h-14 items-center gap-2 border-b bg-card px-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-medium capitalize text-muted-foreground", children: [
          role,
          " dashboard"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationBell, {}) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 p-4 sm:p-6 md:p-8 overflow-x-hidden", children: role === "admin" ? /* @__PURE__ */ jsxRuntimeExports.jsx(AdminDashboard, {}) : role === "teacher" ? /* @__PURE__ */ jsxRuntimeExports.jsx(TeacherSummary, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(LearnerDashboard, {}) })
    ] })
  ] }) });
}
export {
