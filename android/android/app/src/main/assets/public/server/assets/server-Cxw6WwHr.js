...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-C4NW4W-f.js");
...
const manifest = {
  "576d0135ae258276f3ecc55e61cc0e30cae4f06f1270eb8d895f0247e84f0a20": {
    functionName: "bulkCreateUsers_createServerFn_handler",
    importer: () => import("./bulk-users.functions-Cv2e3r08.js")
  },
  "9bbb7c14a0ddc72c5256a0aebc364ab3c0d1d93312f6246455149d3b8d58cdc2": {
    functionName: "deleteUserAsAdmin_createServerFn_handler",
    importer: () => import("./admin-users.functions-0MBEjNt8.js")
  },
  "a995ef04de62c20e35d757dc35d3d1c7d34c66ae79915914d353715ec9da631a": {
    functionName: "setLandingCacheHeaders_createServerFn_handler",
    importer: () => import("./index-DaB8y8E_.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BcETnmHN.js").then((n2) => n2.g),
    import("./start-BCwPrIvX.js"),
