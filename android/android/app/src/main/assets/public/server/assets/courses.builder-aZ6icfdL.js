import { Y as reactExports, R as React, P as jsxRuntimeExports } from "./server-Cxw6WwHr.js";
import { r as reactDomExports, b as Route, u as useAuth, h as useNavigate, t as toast, L as Link } from "./router-BcETnmHN.js";
...
import { C as ChevronLeft, a as ChevronRight, F as Film, H as Headphones, N as NotebookPen } from "./notebook-pen-CbtRftX4.js";
...
function BuilderPage() {
  ...
  const [courseId, setCourseId] = reactExports.useState(editId ?? null);
  const [loading, setLoading] = reactExports.useState(!!editId);
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      ...
      const {
        data: c
      } = await supabase.from("courses").select("*").eq("id", editId).maybeSingle();
      if (c) {
        setTitle(c.title ?? "");
      ...
      const {
        data: ms
      } = await supabase.from("modules").select("id,title,position").eq("course_id", editId).order("position");
      ...
      setModules((ms ?? []).map((m) => ({
        ...
        lessons: lessons.filter((l) => l.module_id === m.id).map((l) => ({
          ...
          remoteId: l.id,
          title: l.title,
          content_type: l.content_type === "doc" ? "text" : l.content_type,
  ...
  const uploadThumb = async (cid, file) => {
    const ext = file.name.split(".").pop()?.toLowerCase() || "jpg";
    const path = `${cid}/thumb-${Date.now()}.${ext}`;
    const {
      error
    } = await supabase.storage.from("course-materials").upload(path, file, {
  ...
  const uploadLessonFile = async (cid, file) => {
  ...
  const saveStep1 = async () => {
    ...
    try {
      ...
      if (cid) {
        const {
          error
        } = await supabase.from("courses").update(payload).eq("id", cid);
        if (error) throw error;
      } else {
        const {
          data,
  ...
  const addModule = () => setModules((ms) => [...ms, {
    id: tmpId(),
  ...
  const updateModule = (id, patch) => setModules((ms) => ms.map((m) => m.id === id ? {
    ...m,
    ...patch
  } : m));
  const addLesson = (modId) => updateModule(modId, {
    lessons: [...modules.find((m) => m.id === modId)?.lessons ?? [], {
      id: tmpId(),
      title: "New lesson",
      content_type: "text",
      content_url: null,
  ...
  const removeLesson = async (modId, lessonId) => {
    ...
    updateModule(modId, {
      lessons: m.lessons.filter((x) => x.id !== lessonId)
    });
  };
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardShell, { title: "Course builder", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center py-20 text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-5 w-5 animate-spin" }),
      " Loading…"
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardShell, { title: editId ? "Edit course" : "Create course", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Stepper, { step }),
    step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Course details" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Title *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: title, onChange: (e) => setTitle(e.target.value), placeholder: "Introduction to Algebra" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Subject" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: subject, onChange: (e) => setSubject(e.target.value), placeholder: "Mathematics" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Description" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { rows: 4, value: description, onChange: (e) => setDescription(e.target.value), placeholder: "What learners will gain from this course." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Thumbnail" }),
          thumbUrl && !thumbFile && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: thumbUrl, alt: "", className: "h-32 w-56 rounded-md object-cover border" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "file", accept: "image/*", onChange: (e) => setThumbFile(e.target.files?.[0] ?? null) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "JPG/PNG, under 5 MB." })
        ] })
      ] })
    ] }),
    step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex-row items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Modules & lessons" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", onClick: addModule, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "mr-1 h-4 w-4" }),
          "Module"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
        modules.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground py-6 text-center", children: "Add your first module to get started." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DndContext, { sensors, collisionDetection: closestCenter, onDragEnd: onModuleDragEnd, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SortableContext, { items: modules.map((m) => m.id), strategy: verticalListSortingStrategy, children: modules.map((m, mi) => /* @__PURE__ */ jsxRuntimeExports.jsx(SortableModuleCard, { module: m, index: mi, onChange: (p) => updateModule(m.id, p), onRemove: () => removeModule(m.id), onAddLesson: () => addLesson(m.id), onLessonDragEnd: onLessonDragEnd(m.id), onLessonChange: (lid, p) => updateLesson(m.id, lid, p), onLessonRemove: (lid) => removeLesson(m.id, lid), sensors }, m.id)) }) })
      ] })
    ] }),
    step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Publish" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-lg", children: title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: [subject, description].filter(Boolean).join(" · ") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex gap-3 text-sm", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: isActive ? "default" : "outline", children: isActive ? "Published" : "Draft" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between rounded-md border px-4 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-base", children: "Visible to learners" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Toggle to publish or unpublish." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { checked: isActive, onCheckedChange: publish, disabled: saving })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dashboard", children: "Back to dashboard" }) }),
          courseId && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/courses/$courseId", params: {
            courseId
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", disabled: step === 1 || saving, onClick: () => setStep((s) => Math.max(1, s - 1)), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "mr-1 h-4 w-4" }),
        " Back"
      ] }),
      step < 3 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { disabled: saving, onClick: next, children: [
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard", children: [
...
function Stepper({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: steps.map((label, i) => {
    const idx = i + 1;
    const active = step === idx;
    const done = step > idx;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold ${done ? "bg-primary text-primary-foreground" : active ? "bg-gold text-gold-foreground" : "bg-muted text-muted-foreground"}`, children: done ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4" }) : idx }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-sm ${active ? "font-semibold" : "text-muted-foreground"}`, children: label }),
      idx < steps.length && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-px flex-1 ${done ? "bg-primary" : "bg-border"}` })
    ] }, label);
  }) });
}
function SortableModuleCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: setNodeRef, style, className: "rounded-lg border bg-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border-b p-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { ...attributes, ...listeners, className: "cursor-grab text-muted-foreground hover:text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GripVertical, { className: "h-4 w-4" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-medium text-muted-foreground", children: [
        "M",
        index + 1
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: m.title, onChange: (e) => onChange({
        title: e.target.value
      }), className: "flex-1", placeholder: "Module title" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "ghost", onClick: onAddLesson, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "mr-1 h-4 w-4" }),
        "Lesson"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", variant: "ghost", onClick: onRemove, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4 text-destructive" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 space-y-2", children: [
      m.lessons.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center py-3", children: "No lessons yet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DndContext, { sensors, collisionDetection: closestCenter, onDragEnd: onLessonDragEnd, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SortableContext, { items: m.lessons.map((l) => l.id), strategy: verticalListSortingStrategy, children: m.lessons.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(SortableLessonRow, { lesson: l, onChange: (p) => onLessonChange(l.id, p), onRemove: () => onLessonRemove(l.id) }, l.id)) }) })
    ] })
  ] });
}
function SortableLessonRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: setNodeRef, style, className: "rounded-md border bg-background p-3 space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { ...attributes, ...listeners, className: "cursor-grab text-muted-foreground hover:text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GripVertical, { className: "h-4 w-4" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-4 w-4 text-muted-foreground" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: lesson.title, onChange: (e) => onChange({
        title: e.target.value
      }), className: "flex-1", placeholder: "Lesson title" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: lesson.content_type, onValueChange: (v) => onChange({
        content_type: v,
        content_url: null,
        content_text: null,
        uploadFile: null
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "video", children: "Video URL" }),
    ...
    lesson.content_type === "video" && /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "https://youtube.com/…", value: lesson.content_url ?? "", onChange: (e) => onChange({
      content_url: e.target.value
    }) }),
    (lesson.content_type === "pdf" || lesson.content_type === "audio") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "file", accept: lesson.content_type === "pdf" ? "application/pdf" : "audio/*", onChange: (e) => onChange({
        uploadFile: e.target.files?.[0] ?? null
      }) }),
      lesson.content_url && !lesson.uploadFile && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground flex items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "h-3 w-3" }),
        " File uploaded — choose a new file to replace."
      ] })
    ] }),
    lesson.content_type === "text" && /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { rows: 3, placeholder: "Lesson text…", value: lesson.content_text ?? "", onChange: (e) => onChange({
      content_text: e.target.value
    }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { rows: 2, placeholder: "Optional notes for learners…", value: lesson.notes ?? "", onChange: (e) => onChange({
